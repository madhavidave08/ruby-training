...
RSpec.describe 'Message passing' do
  ...
  it 'can also use __send__ to perform the same behaviour' do
    ...
    # THINK ABOUT IT: Why does Ruby provide both send and __send__ ? send can be overridden by subclass where as __send__ cant be overridden (protected fallback)
